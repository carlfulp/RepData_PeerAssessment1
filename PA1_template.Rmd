...
The mean number of steps, rounded to the neareste step, taken per day was **`r stepsMean`**.
The median number of steps, rounded to the neareste step,  taken per day was **`r stepsMedian`**.
