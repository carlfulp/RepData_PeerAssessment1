...
the maximum number of steps occurs at **`r maxInterval`**.
...
steps respectively, while the postimputation mean and median were **`r stepsImputedMean`** and **`r stepsImputedMedian`** steps respectively.
